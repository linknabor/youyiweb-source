...
<template>
	<div>
		<div class="title_area">
		    ...
		    <div class="brand-tip-2" v-if="!publicProject">我们将尽快安排师傅上门维修</div>
		    <div class="brand-tip-2" v-else>
		    该维修项目或维修设施属于公共部位<br/>
		    我们将通知物业管理处进行处理<br/>
		    感谢你的反馈
		    </div>
	    ...
	    <div class="top-info bottom-line">
	        ...
	        <div class="item">
	            <label>维修项目</label><span class="value">{{order.projectName}}</span>
	        </div>
	    </div>
...
<script>
	...
	export default {
		...
		methods:{
			...
			goback(){
				window.location.href = vm.config.repair_success.url1;
			}
		}
	}
</script>